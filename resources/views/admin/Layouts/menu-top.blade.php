...
{{--                    <a class="dropdown-item dropdown-item-custom" href="{{ route('admin.setting.index') }}">--}}
{{--                        <i class="mdi mdi-settings-box mr-2 text-success"></i> Cài đặt </a>--}}
...
{{--                    <a class="dropdown-item preview-item">--}}
{{--                        <div class="preview-thumbnail">--}}
{{--                            <img src="../resources/admin/assets/images/faces/face2.jpg" alt="image" class="profile-pic">--}}
{{--                        </div>--}}
{{--                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">--}}
...
{{--                    <a class="dropdown-item preview-item">--}}
{{--                        <div class="preview-thumbnail">--}}
{{--                            <img src="../resources/admin/assets/images/faces/face3.jpg" alt="image" class="profile-pic">--}}
{{--                        </div>--}}
{{--                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">--}}
